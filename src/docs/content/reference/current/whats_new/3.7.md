...
`gatling-highcharts-maven-archetype` for Scala/maven and `gatling.g8` for Scala/sbt/giter8 are discontinued. Instead, please check the samples on GitHub repos

* [Java maven demo](https://github.com/gatling/gatling-maven-plugin-demo-java)
* [Kotlin maven demo](https://github.com/gatling/gatling-maven-plugin-demo-kotlin)
* [Scala maven demo](https://github.com/gatling/gatling-maven-plugin-demo-scala)
